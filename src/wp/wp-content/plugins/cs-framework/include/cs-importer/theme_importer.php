...
if ( ! function_exists( 'cs_theme' ) ) {
     ...
     */
    function cs_theme() {
        add_theme_page( 'Import Demo Data', __( 'Import Demo Data', THEME_TEXT_DOMAIN ), 'read', 'cs_demo_importer', 'cs_demo_importer' );
    }
...
if ( ! function_exists( 'cs_demo_importer' ) ) {
    ...
    function cs_demo_importer() {
        ...
        if ( function_exists( 'get_plugin_requirements' ) ) {
            ...
            wp_die( __( 'Plugin requirements not available.', THEME_TEXT_DOMAIN ) );
        }
                                        ...
                                        <li class="users-chk-wrapper hidden <?php echo $is_job_hunt_installed ? '' : 'error'; ?>">
                                            <div class="radiobox">
                                                ...
                                                <label for="chk-users" class="checkbox-data-import-type">
                                                    ...
                                                    <?php echo $is_job_hunt_installed ? '' : '<br>Please install Job Hunt Plugin.'; ?>
                                                </label>
                                            </div>
                                        </li>
...
function cs_import_demo_data_callback() {
    ...
    if ( 'import_data' == $action_type ) {
        ...
        if ( 'content' == $import_type ) {
            ...
            $cs_importer->wp_data_path = isset( $urls['content'] ) ? $urls['content'] : '';
            ...
            $cs_importer->attachments_replace_url = ATTACHMENTS_REPLACE_URL;
            ...
            $cs_importer->plugins_data_path = isset( $urls['plugins'] ) ? $urls['plugins'] : '';
