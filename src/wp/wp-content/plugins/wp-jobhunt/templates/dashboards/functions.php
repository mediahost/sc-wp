...
if ( ! function_exists( 'cs_get_user_avatar' ) ) {
	...
	function cs_get_user_avatar( $size = 0, $cs_user_id = '' ) {
		...
		if ( $cs_user_id != '' ) {
			...
			$cs_user_avatars = get_the_author_meta( 'user_avatar_display_1', $cs_user_id );
...
if ( ! function_exists( 'cs_get_img_url' ) ) {
	...
	function cs_get_img_url( $img_name = '', $size = 'cs_media_2', $return_sizes = false, $dir_filter = true ) {
		...
		if($size == 'cs_media_6' || $size == 'cs_media_5'|| $size == 'cs_media_4'){
			...
			if ( $custom_query->have_posts() ):
				...
				while ( $custom_query->have_posts() ): $custom_query->the_post();
					...
					if ( $employer_img == '' ) {
						...
						$cs_jobs_thumb_url = cs_get_img_url( $employer_img, 'user_avatar' );
					}
