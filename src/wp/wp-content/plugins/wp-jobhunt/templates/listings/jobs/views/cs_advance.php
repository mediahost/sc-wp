                            ...
                            <div class="jobs-content">
                                <div class="cs-media">
                                    ...
                                    <?php } if (isset($cs_job_featured) and $cs_job_featured == 'yes' || $cs_job_featured == 'on') { ?>
                                        <span title="" data-placement="top" data-toggle="tooltip" class="feature-post" data-original-title="<?php _e('Featured', 'jobhunt') ?>"><i class=" icon-star-o"></i></span><?php } ?>

                                </div>
                                <div class="cs-text">
                                    <div class="post-title">
                                        <h5><a href="<?php echo esc_url(get_permalink($post->ID)); ?>"><?php the_title(); ?></a></h5>
                                    </div>
                                    ...
                                    <div class="job-post"> 
                                        ...
                                        if (!is_user_logged_in() || !$login_user_is_employer_flag) {
                                            ...
                                            if (is_user_logged_in()) {
                                                ...
                                                ?>
                                                <a class="heart-btn heart-btn shortlist" data-toggle="tooltip" data-placement="top" title="<?php _e("Add to Shortlist", "jobhunt"); ?>" onclick="trigger_func('#btn-header-main-login');"><i class='icon-heart-o'></i></a>
                                                <?php
                                            }
                                        } else {
                                            ?>
                                            <a class="whishlist_icon heart-btn shortlist" href="javascript:void(0)"  data-toggle="tooltip" data-placement="top" title="<?php _e("Add to Shortlist", "jobhunt"); ?>" id="<?php echo 'addjobs_to_wishlist' . intval($post->ID); ?>" onclick="show_alert_msg('<?php echo __("Become a candidate then try again.", "jobhunt"); ?>')" ><i class="icon-heart-o"></i></a>
                                                <?php
                                            }
                                            ?>
